        ...
        <div class="gaya-form">
            <form action="<?= BASEURL; ?>/Po/tambah/" method="post">
                <label for="no_po">
                    ...
                    <input type="text" class="input-text" name="no_po" value="" />
                </label>
                <label for="jenis_po">
                    <span>JENIS PO</span>
                ...
                <label for="tgl_mulai">
                    ...
                    <input type="date" class="input-text" name="tgl_mulai" value=""/>
                </label>
                <label for="tgl_selesai">
                    <span>TGL SELSAI <span class="required">*</span></span>
                    <input type="date" class="input-text" name="tgl_selesai" value=""/>
                </label>
